...
in-AChecker files; those are files that only get used when using or administering AChecker. 
The in-AChecker files format the dropdowns and the overall look of AChecker.